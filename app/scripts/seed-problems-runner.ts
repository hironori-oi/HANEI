 ...
 *     W4 (221 問 / choice 181 + reading-passage 40) = **計 822 問**
...
async function main(): Promise<void> {
  ...
  if (summary.total !== 822) {
    console.warn(
      `[seed-runner] WARNING: total=${summary.total} (expected 822). seed-id-mapper の採番ロジックに変更があった可能性があります。`,
    );
  }
}
